...
dtsd_1352_ns = cg.esphome_ns.namespace("dtsd_1352")
dtsd1352 = dtsd_1352_ns.class_(
    "dtsd1352", cg.PollingComponent, modbus.ModbusDevice
)
...
CONFIG_SCHEMA = (
    cv.Schema({cv.GenerateID(): cv.declare_id(dtsd1352)})
    .extend(
